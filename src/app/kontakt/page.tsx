	...
	return (
		<main className="md:bg-[url('/bg1.png')] bg-contain bg-no-repeat bg-right flex h-[110vh]">
			<div className="absolute">
      		...
      		<div className="w-full max-w-[80%] mx-auto max-h-[30%] mt-[30%] md:w-[900px] md:h-[450px] md:mt-40 md:ml-35">
      			<iframe
			    ...
			    ></iframe>
				<div className="flex flex-col text-base gap-5 ml-5 mt-10 md:text-2xl md:flex-row md:gap-20">
